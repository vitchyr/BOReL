...
def main(debug, suffix, nseeds, mode):
    ...
    default_params = {
        ...
        'pretrained_vae_dir': "/preloaded_data/21-05-20_borel-exp1_vae_ant_dir_4/run0_22h-34m-19s/trained_vae/",
        'offline_buffer_path_to_save_to': '/preloaded_data/demos/ant_dir_4_1200_each/pearl_buffer_iter400_relabelled/',
